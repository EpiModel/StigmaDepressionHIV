...
source("R/C-netsim_scenarios/42.2-processfxns_mddtbl2.R")
...
saveRDS(fulldata, paste0(save_dir, "/fulldata_mddtbl2", tblnam,".rds"))
...
saveRDS(outcomessce, paste0(save_dir, "/outcomessce_mddtbl2", tblnam, ".rds"))
