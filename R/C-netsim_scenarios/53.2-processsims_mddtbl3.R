...
source("R/C-netsim_scenarios/53.3-processfxns_mddtbl3.R")
...
sims_dir <- paste0("data/intermediate/scenarios_mddtbl3/redusims")
...
saveRDS(fulldata, paste0(save_dir, "/fulldata_mddtbl3", fr1, "_", fr2,".rds"))
...
saveRDS(outcomessims, paste0(save_dir, "/outcomessims_mddtbl3", fr1, "_", fr2, ".rds"))
...
saveRDS(outcomessce, paste0(save_dir, "/outcomessce_mddtbl3", fr1, "_", fr2, ".rds"))
...
redusims_dir <- paste0("data/intermediate/scenarios_mddtbl3/redusims")
